...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'lumaai/shims/${shims.kind}'\` before importing anything else from lumaai`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'lumaai/shims/${shims.kind}'\` after \`import 'lumaai/shims/${exports.kind}'\``);
    }
